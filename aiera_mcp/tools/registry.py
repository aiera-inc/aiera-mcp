...
TOOL_REGISTRY = {
    ...
    "find_research_subjects": {
        "display_name": "Find Research Subjects",
        "input_schema": FindResearchSubjectsArgs.model_json_schema(),
        "function": find_research_subjects,
        "args_model": FindResearchSubjectsArgs,
        "category": "research",
        "read_only": True,
        "destructive": False,
    },
    "find_research_product_focuses": {
        "display_name": "Find Research Product Focuses",
        "input_schema": FindResearchProductFocusesArgs.model_json_schema(),
        "function": find_research_product_focuses,
        "args_model": FindResearchProductFocusesArgs,
        "category": "research",
        "read_only": True,
        "destructive": False,
    },
    "find_research_discipline_types": {
        "display_name": "Find Research Discipline Types",
        "input_schema": FindResearchDisciplineTypesArgs.model_json_schema(),
        "function": find_research_discipline_types,
        "args_model": FindResearchDisciplineTypesArgs,
        "category": "research",
        "read_only": True,
        "destructive": False,
    },
    "find_research_region_types": {
        "display_name": "Find Research Region Types",
        "input_schema": FindResearchRegionTypesArgs.model_json_schema(),
        "function": find_research_region_types,
        "args_model": FindResearchRegionTypesArgs,
        "category": "research",
        "read_only": True,
        "destructive": False,
    },
    "find_research_country_codes": {
        "display_name": "Find Research Country Codes",
        "input_schema": FindResearchCountryCodesArgs.model_json_schema(),
        "function": find_research_country_codes,
        "args_model": FindResearchCountryCodesArgs,
        "category": "research",
        "read_only": True,
        "destructive": False,
    },
