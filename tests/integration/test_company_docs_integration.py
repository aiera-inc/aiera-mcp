...
class TestCompanyDocsIntegration:
        ...
        with patch("aiera_mcp.tools.base.get_http_client", mock_get_http_client):
            ...
            for doc in result.documents:
                ...
                assert (
                    ...
                    or "presentation" in doc.category.lower()
                )
    ...
    async def test_get_company_doc_real_api(
        ...
        with patch("aiera_mcp.tools.base.get_http_client", mock_get_http_client):
            ...
            find_args = FindCompanyDocsArgs(
                start_date="2023-01-01", end_date="2023-12-31", page_size=1
            )
    ...
    async def test_get_company_doc_categories_with_search(
        ...
        with patch("aiera_mcp.tools.base.get_http_client", mock_get_http_client):
            ...
            for category in result.categories:
                assert isinstance(category, CategoryKeyword)
                assert (
                    "presentation" in category.category_name.lower()
                    or "present" in category.category_name.lower()
                )
    ...
    async def test_get_company_doc_keywords_with_search(
        ...
        with patch("aiera_mcp.tools.base.get_http_client", mock_get_http_client):
            ...
            for keyword in result.keywords:
                assert isinstance(keyword, CategoryKeyword)
                assert (
                    "financial" in keyword.keyword_name.lower()
                    or "finance" in keyword.keyword_name.lower()
                )
    ...
    async def test_company_docs_pagination_integration(
        ...
        with patch("aiera_mcp.tools.base.get_http_client", mock_get_http_client):
            ...
            args_page1 = FindCompanyDocsArgs(
                start_date="2023-01-01", end_date="2023-12-31", page=1, page_size=5
            )
            ...
            if result_page1.total > 5:
                ...
                args_page2 = FindCompanyDocsArgs(
                    start_date="2023-01-01", end_date="2023-12-31", page=2, page_size=5
                )
    ...
    async def test_company_docs_api_error_handling(
        ...
        with patch(
            ...
            args = FindCompanyDocsArgs(start_date="2023-10-01", end_date="2023-10-31")
    ...
    async def test_company_docs_multiple_tools_integration(
        ...
        with patch("aiera_mcp.tools.base.get_http_client", mock_get_http_client):
            ...
            if categories_result.categories:
                ...
                find_result = await find_company_docs(
                    FindCompanyDocsArgs(
                        start_date="2023-01-01", end_date="2023-12-31", page_size=1
                    )
                )
    ...
    async def test_company_docs_citations_integration(
        ...
        with patch("aiera_mcp.tools.base.get_http_client", mock_get_http_client):
            ...
            args = FindCompanyDocsArgs(
                start_date="2023-01-01", end_date="2023-12-31", page_size=5
            )
